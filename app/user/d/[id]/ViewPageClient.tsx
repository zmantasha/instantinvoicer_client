...
import { BadgeInfo, Calendar, ChevronDown, Delete, Dot, Edit, User } from "lucide-react"
...
export default function ViewPageClient({
  ...
  const [invoiceItem, setInvoiceItem] = useState(initialInvoice)
  ...
  useEffect(() => {
    if (searchParams.get('openModal') === 'true') {
      setShareUrl(`${window.location.protocol}//${window.location.host}/share/${id}`)
      setModalOpen(true)
    }
  }, [searchParams])
...
// // copy url
  ...
  // Rest of your client-side logic (handleStatusChange, handleDelete, etc.)
  // ... (keep all the existing handlers and UI components from your original code)
                   ...
                   <div className={styles.headerTop}>
                     ...
                     <p>
                       <span>
                         ...
                         {new Date(invoiceItem.invoiceDetails.date).toLocaleDateString('en-GB', {
                            day: '2-digit',
                            month: '2-digit',
                            year: 'numeric'
                          })}
